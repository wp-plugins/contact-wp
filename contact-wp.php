...
<p><?php _e("Extra Settings", 'mt_trans_domain' ); ?> 
<br /><input type="checkbox" name="<?php echo $data_field_name_2; ?>" value="Yes" <?php echo $change1; ?>>Subject Field?<br />
<input type="checkbox" name="<?php echo $data_field_name_4; ?>" value="Yes" <?php echo $change4; ?>>Phone Number Field?<br />
<input type="checkbox" name="<?php echo $data_field_name_8; ?>" value="Yes" <?php echo $change6; ?>>Address Fields?<br />
</p><hr />
...
if ($option_recaptcha=="Yes") { echo '<p>CAPTCHA*: ' . recaptcha_get_html($publickey, $error) . '</p>'; }
...
echo "<p style='font-size:x-small'>Contact Plugin made by <a href='http://www.gemstoneglobesreview.com'>Gemstone Globes</a></p>";
}
